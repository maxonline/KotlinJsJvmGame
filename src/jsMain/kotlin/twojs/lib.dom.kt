...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$1`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$2`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
...
external interface XPathEvaluatorBase {
    ...
    fun createExpression(expression: String, resolver: `T$3`? = definedExternally): XPathExpression
    fun createNSResolver(nodeResolver: Node): dynamic /* (prefix: String?) -> String? | `T$3` */
    ...
    fun evaluate(expression: String, contextNode: Node, resolver: `T$3`? = definedExternally, type: Number = definedExternally, result: XPathResult? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$3`? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$3`? = definedExternally, type: Number = definedExternally): XPathResult
}
